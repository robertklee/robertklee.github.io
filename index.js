    ...
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          answer: "The hot path in vector search is the similarity comparison \u2014 the distance kernel that dominates the cost of every query. I accelerated that inner loop with SIMD, then pushed further: vectorizing dot-product, cosine, and Euclidean distance to process many dimensions per instruction, unrolling the loop and using multiple independent accumulators so pipelined FMA units stay busy instead of stalling on a dependency chain, and laying out data so loads stay cache-friendly and prefetch-predictable. For binary-quantized vectors it's bit-parallel Hamming distance with hardware popcount. Squeezing instruction-level parallelism out of that kernel is where most of the latency win actually comes from."
        }
      ]
    },
    {
